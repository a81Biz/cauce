...
| PT-113 | BUG | S2 | DONE | EP-020 | La 12.0.1: la guia de migracion que se publico incompleta |
| PT-114 | BUG | S1 | DONE | EP-020 | El cuerpo del issue no se republica cuando aparece la ref durable |
| PT-120 | BUG | S1 | DONE | EP-020 | publicar.yml no ejecuta sellar, y verify-fdge corre sin GH_TOKEN |
| PT-121 | BUG | S1 | DONE | EP-020 | El viaje de vuelta tras el merge no lo cubre ninguna fase |
| PT-122 | BUG | S2 | DONE | EP-020 | El cierre de un lote pasa por el comando, no por la mano |
...
| PT-127 | BUG | S1 | DONE | EP-020 | Nada detecta el trabajo sin allocation: solo lo corta una persona |
| PT-129 | BUG | S2 | DONE | EP-020 | FDGE-R19 enumera tres niveles, el arbol tiene cuatro tipos, y nada compara las ramas reales |
| PT-130 | BUG | S2 | DONE | EP-020 | Una comprobacion cuyo alcance es todo el texto acusa a quien describe el hecho |
...
| PT-135 | BUG | S2 | DONE | EP-020 | El lint de helpers solo mira los usados como comando de un caso: los de montaje se usan antes de definirse y nadie lo ve |
| PT-136 | BUG | S2 | DRAFT | EP-020 | Cerrar un BUG y cerrar un lote no tenian comando: la unica via era escribir el registro a mano |
