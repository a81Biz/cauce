...
| PT-016 | CHORE | S4 | DONE | EP-013 | Decidir si `phase` pasa a ser obligatoria, y añadirla a la plantilla TAREA.md |
| PT-017 | CHORE | S4 | DONE | EP-013 | migrate: derivar la lista de «qué llega nuevo» comparando paquete y destino |
...
| PT-023 | CHORE | S2 | IN_PROGRESS | EP-013 | Auditar si PT-018 declaro mas cambios de especificacion que no hizo |
...
| PT-047 | BUG | S3 | DONE | EP-013 | PHASE 5 manda crear rama por PT y los 43 PT de este repositorio se implementaron sobre trabajo |
| PT-048 | BUG | S3 | DONE | EP-013 | El cuerpo del issue de una allocation DEFERRED enlaza a un directorio que no existe |
