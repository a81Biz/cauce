...
| PT-030 | FEATURE | S1 | DONE | EP-007 | tracker siguiente: que toca y como se cierra, derivado del tablero |
| PT-031 | BUG | S1 | VALIDATION_PENDING | EP-007 | MANUAL, SUPERVISED y AUTONOMOUS deben declarar las mismas obligaciones |
| PT-032 | FEATURE | S1 | DEFERRED | — | Convencion o agente propio que ate al agente al tablero |
