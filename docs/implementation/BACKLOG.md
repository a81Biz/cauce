...
| PT-205 | BUG | S2 | DRAFT | 1 | [#378](https://github.com/a81Biz/cauce/issues/378) | Cumplir SUITE-R34 exige un acto fuera del comando |

**9 de 16 cerradas.** Las cifras salen del registro: no se transcriben (`PT-091`).
