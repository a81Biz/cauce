...
**9 de 14 cerradas.** Las cifras salen del registro: no se transcriben (`PT-091`).

## Implementación abierta — `EP-027`

`EP-027` · **Saldar la deuda que PT-203 hizo visible: 26 firmas de lote certificadas** · `DRAFT` · issue —.
