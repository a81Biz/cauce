...
| 4 | PT-059 | S1 | INTEGRATED | 10 | [#106](https://github.com/a81Biz/cauce/issues/106) | La compuerta `SAFE`/`MARGINAL`/`UNSAFE` y `BLOCKED_BY_CONTEXT` |
| 5 | PT-060 | S2 | INTEGRATED | 10 | [#107](https://github.com/a81Biz/cauce/issues/107) | `SESSION.json` y el handoff **derivado** |
