...
> Regenerado el 2026-08-18 al cerrar `PT-057` en `PHASE 8`. Cada fila se **deriva** del registro y no se edita a
...
| 2 | PT-057 | S2 | READY | 7 | [#104](https://github.com/a81Biz/cauce/issues/104) | El coste de una tarea, **derivado** de las 56 cerradas |
