...
|:---|:---|--:|--:|:---|:---|:---|:---|
| `CE-001` | El proxy en lugar del hecho | 22 | 12 | 2026-08-20 | 2026-08-29 | **—** | **sin dueño** |
...
- `CE-001` **El proxy en lugar del hecho** — 22 instancia(s) · la propia entrada llegó a declarar **12**
