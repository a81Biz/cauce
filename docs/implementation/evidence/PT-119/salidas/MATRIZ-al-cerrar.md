...
165 entradas recorridas · 143 identificadores · 67 instancias · 17 clases declaradas · datos de 2026-08-13 a 2026-08-23

| Clase | Qué es | Veces | Ordinal declarado | Primera | Última | Regla dueña | ¿Puede fallar? |
|:---|:---|--:|--:|:---|:---|:---|:---|
| `CE-001` | El proxy en lugar del hecho | 7 | 12 | 2026-08-20 | 2026-08-23 | **—** | **sin dueño** |
| `CE-002` | Rotura de escapado | 8 | 7 | 2026-08-21 | 2026-08-23 | `SUITE-R59` | **NO**: la regla existe y nada emite por ella |
| `CE-003` | Un argumento se cuela por la detección de `ROOT` | 7 | 7 | 2026-08-18 | 2026-08-23 | **—** | **sin dueño** |
| `CE-004` | Probar donde trabajo, no donde se decide | 8 | 9 | 2026-08-18 | 2026-08-23 | **—** | **sin dueño** |
| `CE-005` | Verde por no haber mirado | 5 | 2 | 2026-08-14 | 2026-08-22 | **—** | **sin dueño** |
| `CE-006` | El acto hecho fuera del comando | 4 | — | 2026-08-21 | 2026-08-23 | `SUITE-R58` · `FDGE-R52` | `SUITE-R58` avisa · `FDGE-R52` falla |
| `CE-007` | Existe la herramienta y nada la echa en falta | 3 | 7 | 2026-08-19 | 2026-08-23 | **—** | **sin dueño** |
...
| `CE-015` | El cierre destapa más que el reparto | 4 | 6 | 2026-08-20 | 2026-08-23 | **—** | **sin dueño** |
...
- `CE-004` **Probar donde trabajo, no donde se decide** — 8 instancia(s) · la propia entrada llegó a declarar **9**
  PT-056 · PT-064 · PT-082 · PT-098 · PT-099 · PT-128 · PT-125 · PT-119
- `CE-001` **El proxy en lugar del hecho** — 7 instancia(s) · la propia entrada llegó a declarar **12**
  PTSA-2026-08-20 · PT-087 · EP-019 · PT-131 · PT-124 · PT-125 · PT-119
- `CE-003` **Un argumento se cuela por la detección de `ROOT`** — 7 instancia(s) · la propia entrada llegó a declarar **7**
  PT-053 · PT-057 · PT-060 · PT-062 · PT-064 · PT-125 · PT-119
- `CE-005` **Verde por no haber mirado** — 5 instancia(s) · la propia entrada llegó a declarar **2**
  PT-044 · PT-047 · PT-016 · PT-057 · EP-019
- `CE-015` **El cierre destapa más que el reparto** — 4 instancia(s) · la propia entrada llegó a declarar **6**
  PTSA-2026-08-20 · EP-018 · EP-019 · PT-125
- `CE-007` **Existe la herramienta y nada la echa en falta** — 3 instancia(s) · la propia entrada llegó a declarar **7**
  PT-079 · PT-114 · PT-125
