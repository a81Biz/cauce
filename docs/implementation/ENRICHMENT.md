...
| PT-115 | FEATURE | S1 | INTEGRATED | EP-020 | PARADA entra al vocabulario y a las reglas |
| PT-116 | FEATURE | S1 | INTEGRATED | EP-020 | tracker parada: el comando que escribe la parada en su tarea |
| PT-117 | FEATURE | S1 | INTEGRATED | EP-020 | Todo desenlace cita la parada que lo produjo |
...
| PT-197 | FEATURE | S2 | DONE | EP-026 | DICTAMEN: el septimo componente y el entregable ejecutivo al dueno del dominio |
