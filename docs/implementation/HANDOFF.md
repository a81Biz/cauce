...
<!-- ESTADO -->
implementación: EP-009 (#52) · el tablero refleja la jerarquia real · EP-010 (#53) en DRAFT, esperando firma
tarea:          PT-035 (#51) y PT-036 (#54) en VALIDATION_PENDING · 24 tareas reanidadas bajo siete lotes
compuerta:      G3 firmada en las dos · paso a DONE humano (SUITE-R06b) · luego G4
siguiente:      cerrar EP-009, version, G4 y publicar. ESO cierra todo lo pendiente antes de EP-010, que es la epica del manual y la que dara la validacion para reemplazar la version
...
actualizado:    2026-08-13 · PHASE 8 de PT-035 y PT-036
<!-- /ESTADO -->
