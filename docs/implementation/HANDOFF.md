...
tarea:          NINGUNA en curso. LAS OCHO están DONE y validadas: los siete BUG por «tracker validar» con la delegación del firmante, y PT-134 como CHORE.
...
siguiente:      PR del cierre a «trabajo» · PR de «trabajo» a main, que ES G4 · «tracker integrar» las ocho y el lote · tag v13.1.0 · «tracker cierre EP-021 --aplicar» · y «tracker cerrar --aplicar» cuando el estado terminal esté en main. La publicación a npm ES DEL FIRMANTE.
