...
<!-- ESTADO -->
implementación: EP-003 · el-issue-se-lee-solo · IN_PROGRESS · issue #13 · G1 PASS — EP-001 y EP-002 CLOSED, en main desde 9ecb1d3
...
compuerta:      G3 de las dos tareas de EP-003 será HUMANA: son BUG y SUITE-R06b no lo automatiza ningún modo. Es la diferencia con EP-002
siguiente:      PT-009 — tracker cerrar comenta sin marca y SUITE-R43 toma su propio mensaje por humano; verify-fdge está en rojo por eso. Después PT-010, el cuerpo del issue. La 6.0.0 sigue SIN PUBLICAR y conviene que siga así hasta cerrar el lote: publicar ahora deja en npm una versión cuyo verify-fdge sale en rojo. Tras el merge: los tres PT DONE pasan a INTEGRATED, EP-001 a CLOSED, y publicar 5.3.0 desde main con publicar.yml, que es manual
