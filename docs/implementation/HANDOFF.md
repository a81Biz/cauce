...
<!-- ESTADO -->
implementación: EP-002 · DONE · issue #9 — y EP-001 · DONE · issue #2. Los dos esperan el MISMO G4 en el PR #7
...
compuerta:      G4 pendiente · Alberto Martínez · humana sin excepción (EXEC-R04, SUITE-R06a). Y la publicación en npm, que también es humana: publicar.yml es manual y desde main
siguiente:      revisar el PR #7 —y qué dice GitGuardian, que no es compuerta de cauce y sigue sin revisar— y apretar el merge. Después: los PT DONE a INTEGRATED, los dos EP a CLOSED, tracker cerrar --aplicar, y publicar 6.0.0 con publicar.yml. Las dos cosas las aprieta una persona. Tras el merge: los tres PT DONE pasan a INTEGRATED, EP-001 a CLOSED, y publicar 5.3.0 desde main con publicar.yml, que es manual
