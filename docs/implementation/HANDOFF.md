...
tarea:          PT-004 · PHASE 6 completa · VALIDATION_PENDING · issue #6 — PT-001 #3, PT-002 #4, PT-003 #5 en READY esperando turno
compuerta:      G3 pendiente · Alberto Martínez · PT-004 es BUG: solo un humano lo lleva a DONE (SUITE-R06b, FDGE-R26). G2 quedó APROBADA por delegación el 2026-08-13, con constancia en design.md
siguiente:      resolver G3 de PT-004 leyendo evidence/PT-004/ — 4 errores de verify-fdge bajaron a 1, selftest de 180 a 188 casos. Con G3 en DONE: PHASE 8 (HISTORY.log) y arrancar PT-001, que cierra el AC-06 pendiente de PT-004
