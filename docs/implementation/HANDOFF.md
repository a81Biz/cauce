...
tarea:          NINGUNA en curso. Queda el PR #315 —el commit de cierre— y despues «tracker cerrar --aplicar» para los issues, que SUITE-R46 exige hacer con el estado terminal YA en main.
...
siguiente:      #315 a trabajo -> PR a main -> tracker cerrar --aplicar. npm publish NO: el firmante lo reservo.
...
actualizado:    2026-08-26 · EP-022 CLOSED, G4 resuelta, pendiente el cierre de issues
<!-- /ESTADO -->
