...
<!-- ESTADO -->
implementación: EP-011 (#59) DONE · el marco se usa a si mismo · las cinco tareas cerradas · 7.6.0 sellada
tarea:          PT-043 DONE en PHASE 8 · PT-039 a PT-042 en VALIDATION_PENDING · PT-044 (#65), PT-045 (#66) y PT-046 (#67) DEFERRED, encontradas ejecutando
compuerta:      G4 pendiente, HUMANA · «verify-fdge --gate G4 PT-043» solo pide ya el pull request (SUITE-R42) · en PT-039..PT-042 falla ademas FDGE-R34: ver PT-046
siguiente:      G4. Abrir el PR —«gh pr create --base main --head trabajo»— y mergear: las dos son humanas y NO estan delegadas. Despues «tracker cerrar --aplicar», en ese orden y no antes (SUITE-R46). NO PUBLICAR: decision humana explicita, y esta en el out-of-scope del lote
