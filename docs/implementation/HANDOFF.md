...
<!-- ESTADO -->
implementación: EP-008 CLOSED · atar el agente al tablero
tarea:          PT-033 y PT-034 INTEGRATED · 7.3.0 sellada · cauce start es el punto de entrada
compuerta:      G4 autorizada por Alberto Martinez · estado terminal apuntado ANTES del merge
siguiente:      mergear, cerrar issues, publicar 7.3.0. Y EMPEZAR LA PROXIMA SESION CON:  npx @a81biz/cauce start. Pendiente en el tablero: PT-019 (#26) migrar el proyecto legado
...
actualizado:    2026-08-13 · cierre de EP-008
<!-- /ESTADO -->
