...
tarea:          PT-021 y PT-022 en VALIDATION_PENDING (issues #29 y #30) · EP-005 completo · EP-004 completo · 7.0.0 sellada
compuerta:      G3 firmada en las dos · su paso a DONE es humano (SUITE-R06b, tipo BUG) · luego G4 sobre el PR #28
siguiente:      poner PT-021 y PT-022 en DONE, cerrar EP-004 y EP-005, mergear el PR #28 (G4, humano) y publicar 7.0.0. Despues: PT-019 (#26) migrar el proyecto legado, y PT-023 auditar si PT-018 declaro mas cambios de especificacion que no hizo
