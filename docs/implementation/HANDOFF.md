...
tarea:          PT-199 DONE en PHASE 8. Siguiente por el orden del lote: PT-201 —las comprobaciones que no pueden correr en local—, que junto con PT-199 completa el par que hace LEGIBLE la corrida.
...
actualizado:    2026-08-29 · EP-026 en marcha · PT-199 DONE: la corrida acotada pasa de 33 errores de andamiaje a CERO. El esqueleto DERIVA sus 172 rutas del propio arnes y ENUMERA las 14 raices por variable que no puede derivar. Coste declarado: la acotada sube de 4m23s a 7m10s, y sigue siendo -77% frente a la completa.
<!-- /ESTADO -->
