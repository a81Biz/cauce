...
<!-- ESTADO -->
implementación: EP-009 CLOSED · solo queda EP-010 (#53), en DRAFT esperando firma
tarea:          ninguna en curso · 7.4.0 sellada · 24 tareas anidadas y los enlaces resuelven
compuerta:      G4 autorizada · estado terminal apuntado ANTES del merge
siguiente:      mergear, cerrar, publicar 7.4.0. Con eso NO QUEDA NADA pendiente salvo EP-010, la epica del manual — que es la que dara la validacion para reemplazar la version
...
actualizado:    2026-08-13 · cierre de EP-009
<!-- /ESTADO -->
