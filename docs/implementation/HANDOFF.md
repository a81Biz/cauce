...
no hacer:       -10) NO fiarse de verify-fdge en verde para dar por hechos los artefactos: es PT-179, S1. Contrastar con «tracker cursor EP-NNN». -11) NO editar tools/ ni derivados con la bateria corriendo: paso TRES veces. -16) EL SELLO DEL HANDOFF VA AL FINAL, EN SU PROPIO COMMIT. SUITE-R34 compara la FECHA DE COMMIT de HANDOFF.md con la de changes/, y la fila de cierre vive en changes/. La nota vieja decia «antes de integrar»; vale para CUALQUIER cosa que toque un intake, incluida la revision del cierre — que por definicion ocurre al final. Paso DOS veces. -12) EL ORDEN DE LOS DERIVADOS: «eventos» ANTES que «matriz», y los dos DESPUES de la ultima edicion, con «inventario». -13) Las banderas son --epica y --severidad, no --epic ni --severity; ahora se rechazan (PT-183), pero el error se cometio DOS VECES. -14) G4 NECESITA UNA RAMA PUENTE: main y trabajo tienen las dos strict:true y se bloquean mutuamente. La rama sale DE trabajo y trae main dentro. Sin eso, ningun PR entre ellas puede fusionarse. -15) Cada tarea nueva pide DOS viajes al tablero: «abrir --aplicar» otra vez DESPUES del commit, porque el ref durable no existe antes (SUITE-R51).
