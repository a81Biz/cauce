...
tarea:          ninguna en curso. EP-026 lista para arrancar por PT-199 y PT-201, que son las que hacen LEGIBLE la propia corrida: mientras la salida escupa 33 errores de andamiaje y el verde local no prediga la CI, cualquier medida que tomen las demas se toma sobre un instrumento sucio.
...
actualizado:    2026-08-28 · EP-025 CLOSED y en main con v13.4.0 · EP-026 ABIERTA con G1 firmada y sus CATORCE tareas DESCOMPUESTAS, cada una con su intake. Ninguna allocation del repositorio queda ya sin citar la parada que la produjo (FDGE-R55): es la primera vez.
<!-- /ESTADO -->
