...
tarea:          ninguna en curso · las cinco de EP-001 cerradas · PT-005 DONE (#8) — PT-004 (#6) y PT-001 (#3) en DONE esperando el G4 del lote · PT-003 #5 en READY
compuerta:      G4 del lote pendiente · Alberto Martínez · humana sin excepción en los tres modos (EXEC-R04, SUITE-R06a). El job «marco» del PR #7 pasa en verde; GitGuardian, que es una integración externa y no una compuerta de cauce, falla y está sin revisar
siguiente:      revisar el PR #7 —incluido qué dice GitGuardian— y apretar el merge. Tras el merge: los cuatro PT DONE pasan a INTEGRATED, EP-001 a CLOSED, tracker cerrar --aplicar cierra sus issues, y publicar 5.3.0 con publicar.yml, que es manual y desde main. Tras el merge: los tres PT DONE pasan a INTEGRATED, EP-001 a CLOSED, y publicar 5.3.0 desde main con publicar.yml, que es manual
