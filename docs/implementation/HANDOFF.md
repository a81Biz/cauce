...
tarea:          PT-049 (#83) es la primera y va en PHASE 1. Orden: PT-049 PT-050 PT-051 PT-052 PT-053 PT-054, y NO es preferencia — las dos primeras cambian como se ejecutan las otras cuatro
...
siguiente:      PT-049 PHASE 1 → PHASE 2. Y, a cargo del firmante y en paralelo, la G4 de EP-013: gh pr create --base main --head trabajo. NO PUBLICAR
