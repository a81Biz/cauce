...
tarea:          PT-047 (#69) DONE en PHASE 8, sobre fix/PT-047-ningun-pt-ha-creado-su-rama · PT-016, PT-015, PT-048, PT-017, PT-020, PT-023 y PT-029 READY detras
compuerta:      G1, G2 y G3 de PT-047 firmadas por delegacion · el PR de la tarea a «trabajo» es REVISION, no G4 · G4 del lote pendiente y sin delegar
siguiente:      PR de PT-047 a trabajo, y PT-016 (MAJOR: phase obligatoria). Desde ahora TODA tarea nace con su rama (FDGE-R19). NO PUBLICAR
...
actualizado:    2026-08-14 · PT-047 cerrado · primera rama por tarea en 47, y verify-fdge la mira por primera vez
<!-- /ESTADO -->
