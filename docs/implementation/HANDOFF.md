...
<!-- ESTADO -->
implementación: EP-012 (#71) DONE · el marco se cierra a si mismo · 7.7.0 sellada, sin publicar
tarea:          PT-046, PT-044 y PT-045 DONE en PHASE 9 · PT-047 (#69) y PT-048 (#70) DEFERRED, salidas de auditar el propio uso del marco
compuerta:      G1, G2 y G3 de las tres firmadas por delegacion con constancia · G4 pendiente, HUMANA y sin delegar
siguiente:      G4 sobre el PR #72. Despues «tracker cerrar --aplicar», en ese orden y no antes (SUITE-R46). NO PUBLICAR: decision humana explicita, «no publicamos aun porque nos falta algo mas»
...
actualizado:    2026-08-14 · EP-012 completo · las tres compuertas G4 con sus precondiciones en verde salvo el merge
<!-- /ESTADO -->
