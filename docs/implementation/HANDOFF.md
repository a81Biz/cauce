...
tarea:          PT-014 en VALIDATION_PENDING (issue #21) · ultima tarea de EP-004 · PT-011, PT-012, PT-013 y PT-018 en DONE
compuerta:      G3 de PT-014 firmada · su paso a DONE es humano (SUITE-R06b, tipo BUG)
siguiente:      cerrar EP-004 con su entrada de CHANGELOG (rompe compatibilidad: SUITE-R44 exige vocabulario cerrado), alinear los 21 documentos con version.mjs y abrir el PR de G4. G4 y la publicacion son del humano. Despues: PT-019 (#26) migrar el proyecto legado, PT-015/016/017/020 aplazados con issue
