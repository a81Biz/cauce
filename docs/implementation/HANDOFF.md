...
<!-- ESTADO -->
implementación: EP-004 · lo-aplazado-no-se-olvida · IN_PROGRESS · issue #17 · G1 PASS
tarea:          PT-018 · PHASE 5 completa (implementado y en verde) · FALTA su PHASE 6, G3 y PHASE 8 · issue #25 — PT-011, PT-012 y PT-013 en DONE · PT-014 (#21) sin empezar
compuerta:      ninguna resuelta pendiente · PT-018 no ha pasado G3 todavía
siguiente:      cerrar PT-018 — evidencia, self-review, G3 y PHASE 8. Luego PT-014 (#21), el cierre de EP-004, la entrada de CHANGELOG (6.1.0: SUITE-R44 es regla vinculante nueva) y el PR de G4. Y DESPUÉS: PT-019 (#26) es migrar el proyecto legado, que ya está asignado y no se puede volver a perder
...
actualizado:    2026-08-13 · suite 6.0.1
<!-- /ESTADO -->
