...
no hacer:       -10) NO fiarse de verify-fdge en verde para dar por hechos los artefactos: da 0 errores sobre una tarea en PHASE 7 SIN manifest. Es PT-179, S1. Contrastar con «tracker cursor EP-NNN». -11) NO editar tools/ ni artefactos derivados con la bateria corriendo: paso TRES veces en esta sesion. -12) Refrescar inventario y matriz DESPUES de la ultima edicion. -13) NO escribir una bandera de memoria: son --epica y --severidad. Ahora se rechazan (PT-183), pero el error se cometio DOS VECES. -14) La rama de ESTE lote lleva nombre de PT-169 y deberia ser «chore/<u>/EP-024-…» (PT-153). NO se renombra: rompe el PR. Se aplica en la SIGUIENTE.
...
actualizado:    2026-08-27 · EP-024 con PR #333 abierto, pendiente G4
<!-- /ESTADO -->
