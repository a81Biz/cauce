...
<!-- ESTADO -->
implementación: ninguna abierta · EP-001 a EP-010 CLOSED
tarea:          ninguna en curso · 7.5.0 sellada · el marco tiene MANUAL.md y CASOS-DE-USO.md
compuerta:      G4 autorizada · estado terminal apuntado ANTES del merge
siguiente:      mergear, cerrar, PUBLICAR 7.5.0. Es la version que se puede entregar a alguien que no estuvo aqui. Despues: PT-019 (#26), la migracion efectiva del legado, y los siete DEFERRED del tablero
...
actualizado:    2026-08-14 · cierre de EP-010
<!-- /ESTADO -->
