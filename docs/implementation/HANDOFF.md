...
tarea:          PT-002 · PHASE 6 completa · VALIDATION_PENDING · issue #4 — PT-004 (#6) y PT-001 (#3) en DONE esperando el G4 del lote · PT-003 #5 en READY
compuerta:      G3 de PT-002 pendiente · Alberto Martínez · el G4 del lote espera a que cierren PT-002 y PT-003
siguiente:      resolver G3 de PT-002 leyendo evidence/PT-002/. Con DONE: PHASE 8 y arrancar PT-003, que es INVESTIGATION y cierra el lote
