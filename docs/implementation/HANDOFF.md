...
tarea:          NINGUNA en curso: las diecisiete estan INTEGRATED. Lo que queda no es de una tarea sino DEL LOTE — el cierre, que va por el acto 4 de diez: el SEGUNDO merge a main que SUITE-R46 impone y que el protocolo declara para que no se descubra chocando.
compuerta:      G4 HECHA y con constancia (EXEC-R04a, SESSION_LOG del 2026-08-30). El VoBo del firmante del 2026-08-31 cubre cerrar issues, comentar hallazgos, etiquetar y limpiar ramas. NO cubre npm publish: sigue reservado por su nombre (SUITE-R06g), asi que npm se queda en la 13.1.0 — medido y dicho en el Dictamen y en tracker versiones.
siguiente:      4) SEGUNDO merge a main (PR #389 a trabajo, y trabajo a main) · 5) «tracker cerrar --aplicar» · 6) «tracker integrar EP-026 --aplicar» · 7) «tracker cierre EP-026 --aplicar» · 8) «tracker proyectar --publicar» · 9) «git tag -a v13.5.0» · 10) borrar las ramas efimeras. Despues: abrir EP-028 y EP-029, y admitir EP-027.
