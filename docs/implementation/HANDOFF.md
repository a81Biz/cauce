...
decisiones:     1) La version es 13.3.0 y NO 13.2.0: la 13.2.0 ya esta en main con otras tres reglas. 2) MINOR, y RIGE_DESDE fija la entrada en 13.3.0 (CE-014). 3) El encabezado de la fila de cierre es «## Cierre del lote» SIN numerar. 4) La evidencia vive en docs/implementation/evidence/. 5) manifest.criteria[].tests y .evidence son ARRAYS. 6) NO se declara suite.coverage. 7) La rama del lote se declara con «tracker rama PT-NNN --declarar», que escribe LA REAL y no la propuesta — hecho para el caso de un lote sobre una sola rama.
no hacer:       -10) NO fiarse de verify-fdge en verde para dar por hechos los artefactos: da 0 errores sobre una tarea en PHASE 7 SIN manifest. Es PT-179, S1. Contrastar con «tracker cursor EP-NNN». -11) NO editar tools/ ni artefactos derivados con la bateria corriendo: paso TRES veces en esta sesion. -12) EL ORDEN DE LOS DERIVADOS: «eventos» ANTES que «matriz» —matriz deriva de EVENTOS.jsonl y eventos lo reescribe—, y los dos DESPUES de la ultima edicion, junto con «inventario». Cuatro rojos de esta sesion salieron de regenerar un derivado cuando su entrada todavia iba a cambiar; el cuarto llego hasta la CI con la bateria local en verde. -13) NO escribir una bandera de memoria: son --epica y --severidad. Ahora se rechazan (PT-183), pero el error se cometio DOS VECES. -14) La rama de ESTE lote lleva nombre de PT-169 y deberia ser «chore/<u>/EP-024-…» (PT-153). NO se renombra: rompe el PR. Se aplica en la SIGUIENTE.
lo que este lote descubrio: NUEVE tareas llegaron a PHASE 5 sin intake (PT-178) · NUEVE PT sin lote por una bandera ignorada en silencio (PT-183) · G4 SE BLOQUEABA A SI MISMA: publicar la rama era lo que la desviaba (PT-184) · la rama de un lote no tenia forma derivable (PT-153) · el espejo acusaba de huerfanos a nueve issues de otra rama (PT-154) · «declara» dejo SIETE paradas huerfanas (PT-159) · la bateria NO se abarato: 23,6 min antes y despues; lo que bajo fue iterar (252 -> 47 s) · la cobertura BAJO al medirla bien: 113 de 244.
