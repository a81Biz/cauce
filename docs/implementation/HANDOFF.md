...
actualizado:    2026-08-29 · EP-026: SEIS de catorce DONE. PT-200 cierra el ahorro que faltaba: verify-fdge pasa de 536.8 s / 197 PT a 50.4 s / 14 PT con 189 saltados por su sello — un -91%. SELLOS-PT.json SE VERSIONA, como SELLOS.json: es la decision, no la prueba.
<!-- /ESTADO -->
