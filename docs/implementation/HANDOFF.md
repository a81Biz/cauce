...
tarea:          PT-021 en VALIDATION_PENDING (issue #29) · EP-005 abierto con PT-021 y PT-022 · EP-004 completo y en G4 con sus cinco tareas
compuerta:      G3 de PT-021 firmada · su paso a DONE es humano (SUITE-R06b, tipo BUG)
siguiente:      PT-022 (#30): SUITE-R44 solo mira las filas que existen; omitirla es invisible y declararla bloquea. Es el defecto grave del lote. Luego cerrar EP-005, sellar 7.0.0 y G4 sobre el PR #28. G4 y publicacion son del humano
