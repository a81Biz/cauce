...
tarea:          PT-011 y PT-012 en DONE — quedan PT-013 (#20) y PT-014 (#21)
compuerta:      ninguna pendiente ahora · G3 de PT-011 y PT-012 resueltas por delegación · G4 del lote al final, humana
siguiente:      PT-013 — lo que un lote aplaza queda en prosa y nada obliga a que vuelva. Después PT-014 y el cierre del lote. El proyecto legado ya baja de 17 hallazgos a 3 y migrate le enumera 7 acciones: MIGRARLO es el trabajo que sigue al lote
