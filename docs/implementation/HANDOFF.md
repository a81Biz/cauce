...
<!-- ESTADO -->
implementación: EP-026 (#331) · 17 tareas, TODAS INTEGRATED. G4 hecha el 2026-08-31 (#388, f05c4a2) con constancia del firmante en SESSION_LOG. v13.5.0 alineada en los 21 documentos, package.json y el registro. El lote nacio con catorce y crecio en marcha —PT-204, PT-205, PT-206— porque cerrar es el primer momento en que todo se mira junto (CE-015).
tarea:          NINGUNA en curso: las diecisiete estan INTEGRATED y EP-026 esta CLOSED. Lo que queda no es de una tarea sino DEL LOTE — el cierre, que va por el acto 9 de diez. Los actos 5 a 8 estan hechos: 17 issues cerrados, el lote a CLOSED, el comentario de cierre publicado en los 17 y la proyeccion en cauce/alberto-martinez. Falta el tag y borrar las ramas efimeras.
compuerta:      G4 hecha DOS veces con constancia (EXEC-R04a, SESSION_LOG del 2026-08-30 y 31): #388 f05c4a2 y #390 d8d8a86. El PR #391 es el TERCERO, y no es una repeticion sino lo que SUITE-R46 impone para cerrar el issue del lote. El VoBo del firmante del 2026-08-31 cubre cerrar issues, comentar hallazgos, etiquetar y limpiar ramas. NO cubre npm publish.
siguiente:      9) «git tag -a v13.5.0» DESPUES del merge (SUITE-R06a) · 10) borrar las ramas efimeras ya fusionadas (FDGE-R19) · y luego cerrar el issue #331 del LOTE, que SUITE-R46 no deja cerrar hasta que CLOSED este en main — es el TERCER viaje por G4 y va en el PR #391. npm publish NO: reservado por su nombre (SUITE-R06g), npm se queda en 13.1.0.
...
actualizado:    2026-08-31 · PT-197 en PHASE 8 Persistencia
<!-- /ESTADO -->
