...
<!-- ESTADO -->
implementación: EP-007 completo (DONE) · EP-008 (#48) abierto en DRAFT, esperando firma
tarea:          PT-030 y PT-031 en DONE · 7.2.0 sellada · PT-033 (#46) y PT-034 (#47) en DRAFT
compuerta:      G4 de EP-007 pendiente · G1 de EP-008 pendiente de firma humana (INTAKE-R06)
siguiente:      apuntar INTEGRATED de PT-030 y PT-031 ANTES del merge (SUITE-R46), mergear, cerrar, publicar 7.2.0. Luego firmar EP-008 y empezar por PT-033: la definicion de «haber consultado el tablero» la escribe el, y PT-034 la CITA, no la copia
...
actualizado:    2026-08-13 · cierre de EP-007 y apertura de EP-008
<!-- /ESTADO -->
