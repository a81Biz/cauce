...
<!-- ESTADO -->
implementación: EP-024 (#306) · 24 tareas · 22 DONE, 1 INTEGRATED (PT-156), 2 DEFERRED con reentrada (PT-171, PT-177). Fila de cierre RESUELTA con sus ocho filas. Version 13.3.0 alineada en los 21 documentos. Sello mecanico resuelto. EP-025 y EP-026 abiertas y sin empezar.
tarea:          NINGUNA en curso. Lo que queda del lote NO es una tarea: es G4, que es humana.
compuerta:      G1 y G2 delegadas con VoBo en SESSION_LOG · G3 aplicada con «tracker validar --aplicar» a los DIEZ BUG, firmante Alberto Martinez · G4 PENDIENTE. Nada fusionado.
siguiente:      G4 · PR de la rama a «trabajo», y de «trabajo» a «main». Despues del merge: «tracker integrar» para pasar a INTEGRATED y «tracker cierre EP-024 --aplicar». El tag v13.3.0 es el paso 8, humano y DESPUES del merge (SUITE-R06a). NPM PUBLISH SIGUE RESERVADO: «Excepto publicar».
decisiones:     1) La version es 13.3.0 y NO 13.2.0: la 13.2.0 ya esta en main declarando otras tres reglas, y todo el lote colgaba de ese numero — eran DOS 13.2.0 distintas. Se vio comparando origin/main con la rama al escribir la fila de cierre. 2) MINOR: ninguna obligacion existente cambia, y RIGE_DESDE fija la entrada en 13.3.0 (CE-014). 3) El encabezado de la fila de cierre es «## Cierre del lote» SIN numerar: RE_CIERRE_LOTE lo busca asi. 4) La evidencia vive en docs/implementation/evidence/. 5) manifest.criteria[].tests y .evidence son ARRAYS. 6) NO se declara suite.coverage: este repositorio no la mide.
no hacer:       -10) NO fiarse de verify-fdge en verde para dar por hechos los artefactos: da 0 errores sobre una tarea en PHASE 7 SIN manifest. Es PT-179, S1. Contrastar con «tracker cursor EP-NNN». -11) NO editar tools/ con la bateria corriendo. -12) Refrescar el inventario DESPUES de la ultima edicion, no antes. -13) NO escribir una bandera de memoria: son --epica y --severidad, no --epic ni --severity. Ahora el comando las rechaza (PT-183), pero el error se cometio DOS VECES en una sesion.
lo que este lote descubrio: NUEVE tareas llegaron a PHASE 5 sin intake (PT-178) · NUEVE PT sin lote por una bandera ignorada en silencio (PT-183) · la rama de un lote no tenia forma derivable (PT-153) · el espejo acusaba de huerfanos a nueve issues de otra rama (PT-154) · «declara» dejo SIETE paradas huerfanas en EP-022 (PT-159) · REJECTED existia y ningun comando lo escribia (PT-162) · la bateria completa NO se abarato: 23,6 min antes y despues, lo que bajo fue iterar (252 -> 47 s).
hallazgo sin tarea: NINGUNO. EP-026 recoge los cuatro: PT-179 (S1) PT-180 PT-181 PT-182. Dos declarados con vuelta al 2026-09-30: si una INVESTIGATION que produce codigo debe seguir exenta (PT-154), y la severidad de PT-179 a PT-182, que la declara el humano en su intake (PT-183).
pregunta abierta: si PT-178 cerro un peldano de una escalera de cinco. «avanzar» ya no sale de PHASE 1 sin intake, y SIGUE saliendo de PHASE 3, 4, 6 y 8 sin los suyos. El mecanismo ya esta escrito en el cursor (RASTRO_H) y nadie lo cablea. Es PT-182.
lo que sigue sin resolverse: PT-025 (#35) DEFERRED · 21 allocations sin suite_version · 4 PT historicos sin lote, declarados y no retrofechados · los 30 nodos «sin rastro» del cursor, muchos falsos por PT-180.
actualizado:    2026-08-27 · EP-024 cerrado salvo G4
<!-- /ESTADO -->
