...
tarea:          PT-006 · DONE · issue #10 — siguiente PT-007 (#11), luego PT-008 (#12) — PT-004 (#6) y PT-001 (#3) en DONE esperando el G4 del lote · PT-003 #5 en READY
...
siguiente:      PT-007 — el issue lleva la fase y la compuerta, derivadas del registro. Después PT-008 y el cierre de EP-002: la versión NO puede ser MINOR porque SUITE-R42 es una regla vinculante nueva. Tras el merge: los tres PT DONE pasan a INTEGRATED, EP-001 a CLOSED, y publicar 5.3.0 desde main con publicar.yml, que es manual
