...
<!-- ESTADO -->
implementación: EP-013 (#73) FIRMADA · el tablero queda limpio · ocho tareas, con PT-047 primera porque cambia como se ejecutan las otras siete
tarea:          PT-047 (#69) READY en PHASE 1 · PT-016, PT-015, PT-048, PT-017, PT-020, PT-023 y PT-029 READY detras · fuera del lote: PT-019 y PT-025
compuerta:      G1 del lote PASS por delegacion, con las cuatro decisiones del firmante escritas en la firma · G4 y publicar sin delegar
siguiente:      PT-047 PHASE 2. El lote sube MAJOR por PT-016 y necesita guia de migracion. NO PUBLICAR
...
actualizado:    2026-08-14 · EP-013 abierta con sus ocho intakes completos y sus AC escritos
<!-- /ESTADO -->
