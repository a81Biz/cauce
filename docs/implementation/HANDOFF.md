...
tarea:          PT-179 en PHASE 8 DONE. Siguiente por el orden del lote: PT-181, la expectativa de un caso comparada como regex — 257 de 1384 llevan metacaracteres.
...
actualizado:    2026-08-29 · EP-026: PT-199, PT-201 y PT-179 DONE. Tres de catorce. La corrida acotada ya no escupe errores, SUITE-R62 declara su segundo limite, y la evidencia que falta cuando YA TOCABA bloquea en vez de avisar — eran TRES reglas, no una.
<!-- /ESTADO -->
