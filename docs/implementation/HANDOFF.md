...
<!-- ESTADO -->
implementación: EP-025 (#326) CLOSED · 11 tareas en estado terminal: 10 INTEGRATED y 1 aplazada (PT-172). v13.4.0 etiquetada en a5f3b676 y G4 HECHA. LA BATERIA SE CERTIFICA POR UNA CORRIDA, NO POR UNA BANDERA (PT-191): completa 1923 casos / 27m24s, y con SU RECIBO se sellaron los 4 bloques; acotada despues 126 casos / 4m23s. EP-026 abierta con seis tareas.
tarea:          PT-200 EN CURSO, PHASE 5, en su rama chore/alberto-martinez/EP-026-PT-200-verify-fdge-no-acota. LO HECHO: SELLOS-PT.json, materialDe(), saltablesPT(), sellarTerminales(), la bandera --sellar, el filtro del bucle y el informe que dice cuantos se saltaron. Ademas se arreglo que tracker.mjs validara los argv de quien lo IMPORTA (verify-fdge lo importa, y rechazaba --sellar): la guarda EJECUTADO_DIRECTO existia pero se calculaba DESPUES del bloque. LO QUE FALTA: los casos de bateria de los cuatro AC, la corrida COMPLETA, evidencia, HISTORY, commit y PR. NO ESTA COMMITEADO.
...
actualizado:    2026-08-29 · EP-026: CINCO de catorce DONE (PT-199, PT-201, PT-179, PT-181, PT-192) y PT-200 A MEDIAS en PHASE 5. Su codigo esta hecho y MEDIDO: verify-fdge --all pasa de 9m11s / 197 PT a 52s / 14 PT con 189 saltados por su sello — un -90%. Le faltan los casos de bateria, la corrida completa y el cierre.
<!-- /ESTADO -->
