...
tarea:          PT-009 (#14) y PT-010 (#15) · PHASE 6 completa · VALIDATION_PENDING las dos
compuerta:      G3 de PT-009 y de PT-010 pendiente · Alberto Martínez · las dos son BUG y SUITE-R06b no lo automatiza ningún modo, así que la delegación no las cubre
siguiente:      resolver G3 de las dos leyendo evidence/PT-009/ y evidence/PT-010/. Con DONE: PHASE 8, cierre de EP-003, entrada de CHANGELOG (6.0.1 — son dos correcciones, ninguna regla cambia) y G4. La 6.0.0 sigue SIN PUBLICAR: publicar antes de cerrar esto dejaría en npm una versión con el cuerpo del issue roto
