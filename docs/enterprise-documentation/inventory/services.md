...
|:---|---:|:---|:---|:---|
| `selftest.sh` | 10611 | 697 casos sobre un proyecto sintético con defectos inyectados | crea y borra `$WORK` | `npm run selftest` · CI |
...
| `revisar-secretos.mjs` | 297 | Escaneo de secretos en árbol e historia git | no | `npm run verify:secretos` · `verificacion.yml` · `publicar.yml` |
