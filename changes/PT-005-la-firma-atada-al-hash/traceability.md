...
| AC-06 | El PR de G4 pasa el paso de secretos | TS-06 | ejecución real del PR #7 · run 31684220959 | salidas/ci-verde.txt | — | VERIFICADO |
...
existe fuera de GitHub. **Verificado el 2026-08-13**: el job `marco` del PR #7 pasa en verde (run 31684220959).
