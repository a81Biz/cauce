# PT-066 — Acciones reservadas al humano   `EXEC-R07`
...
declarada a `SUITE-R42` y registrada en `SESSION_LOG.md`. Queda **ejecutado**.

## 2 · `G4` — merge del lote a la rama por defecto

**Humano en los tres modos, sin excepción** (`EXEC-R04`, `SUITE-R06a`). Es del **lote**
(`EXEC-R03`). Se describirá cuando `EP-017` cierre.

## 3 · Publicar la `9.0.0`

**Reservado y no autorizado.** Posterior al cierre del lote.
